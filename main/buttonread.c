...
void start_buttonread() {
  ...
  ESP_ERROR_CHECK(iot_button_register_cb(btn, BUTTON_SINGLE_CLICK, NULL,
                                         button_single_click_event_cb, NULL));
  ESP_ERROR_CHECK(iot_button_register_cb(btn, BUTTON_DOUBLE_CLICK, NULL,
                                         button_double_click_event_cb, NULL));
  ESP_ERROR_CHECK(iot_button_register_cb(btn, BUTTON_LONG_PRESS_UP, NULL,
                                         button_long_press_event_cb, NULL));
  ESP_ERROR_CHECK(iot_button_register_cb(btn, BUTTON_PRESS_REPEAT, NULL,
                                         button_repeat_event_cb, NULL));
}
